...
beautiful.init("/home/alejo/.config/awesome/themes/default/theme.lua")
...
tags = {
  names = { "[1] main", "[2] soc", "[3] org", "[4] media", "[5] work", "[6] etc" }, 
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "= web", alejomenuWeb },
                                    { "= social", alejomenuSocial },
                                    { "= files", alejomenuFiles },
                                    { "= editors", alejomenuEditors },
                                    { "= dev", alejomenuDev },
                                    { "= office", alejomenuOffice },
                                    { "= org", alejomenuOrg },
                                    { "= grafix", alejomenuGrafix },
                                    { "= media", alejomenuMedia },
                                    { "= games", alejomenuGames },
                                    { "= sys", alejomenuSys },
                                    { "= terms", alejomenuTerms },
...
-- {{{ Alejo's Custon Wibox

-- Create a wibox for each screen and add it
alejocustomwibox = {}

alejocustomtasklist = {}
alejocustomtasklist.buttons = awful.util.table.join(
                     awful.button({ }, 1, function (c)
                                              if c == client.focus then
                                                  c.minimized = true
                                              else
...
-- 
    -- Create the wibox
    alejocustomwibox[s] = awful.wibox({ position = "bottom", screen = s })
...
--     -- Now bring it all together (with the tasklist in the middle)
    local layout = wibox.layout.align.horizontal()
--     layout:set_left(left_layout)
    layout:set_middle(alejocustomtasklist[s])
--     layout:set_right(right_layout)
...
-- {{{ !!! FIX THIS !!! START conky on start 
-- awful.util.spawn("conky")
-- }}}

-- {{{ !!! FIX THIS !!! START volume manager on start
-- awful.util.spawn("amixer -D pulse set Master 1+ toggle")
-- }}}

-- {{{ START nm-applet wifi / network manager on start 
